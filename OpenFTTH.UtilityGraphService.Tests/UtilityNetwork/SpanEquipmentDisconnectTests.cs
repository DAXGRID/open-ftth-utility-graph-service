...
{
    [Order(1000)]
    public class SpanEquipmentDisconnectTests
    {
        ...
        public SpanEquipmentDisconnectTests(IEventStore eventStore, ICommandDispatcher commandDispatcher, IQueryDispatcher queryDispatcher, IExternalEventProducer externalEventProducer)
        {
