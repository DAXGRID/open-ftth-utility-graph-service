...
{
    [Order(1400)]
    public class SpanEquipmentFullConnectTests
    {
        ...
        public SpanEquipmentFullConnectTests(IEventStore eventStore, ICommandDispatcher commandDispatcher, IQueryDispatcher queryDispatcher, IExternalEventProducer externalEventProducer)
        {
