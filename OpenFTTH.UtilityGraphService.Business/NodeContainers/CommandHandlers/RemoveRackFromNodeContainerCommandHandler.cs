...
namespace OpenFTTH.UtilityGraphService.Business.SpanEquipments.CommandHandlers
{
    public class RemoveRackFromNodeContainerCommandHandler : ICommandHandler<RemoveRackFromNodeContainer, Result>
    {
        ...
        public RemoveRackFromNodeContainerCommandHandler(IEventStore eventStore, ICommandDispatcher commandDispatcher, IQueryDispatcher queryDispatcher, IExternalEventProducer externalEventProducer)
        {
