...
namespace OpenFTTH.UtilityGraphService.Model.Specification
{
    public class SpanEquipmentProductAssetModel : IProductAssetModel
    {
        ...
        readonly SpanEquipmentSpecificationDTO _specification;

        public SpanEquipmentProductAssetModel(Guid mRID, string name, string version, IManufacturer manufacturer, SpanEquipmentSpecificationDTO specification)
        {
            _mRID = mRID;
            _name = name;
            _version = version;
