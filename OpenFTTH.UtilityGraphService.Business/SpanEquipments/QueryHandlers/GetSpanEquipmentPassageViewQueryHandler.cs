        ...
        : IQueryHandler<GetSpanEquipmentPassageView, Result<SpanEquipmentPassageViewModel>>
    {
        ...
        public Task<Result<SpanEquipmentPassageViewModel>> HandleAsync(GetSpanEquipmentPassageView query)
        {
            ...
            foreach (var spanEquipmentOrSegmentId in query.SpanEquipmentOrSegmentIds)
            {
                ...
                {
                    spanEquipmentViewInfos.Add(BuildSpanEquipmentView(query, spanEquipment, spanEquipmentOrSegmentId));
                }
                else
                {
        ...
        private SpanEquipmentPassageViewEquipmentInfo BuildSpanEquipmentView(GetSpanEquipmentPassageView query, SpanEquipment spanEquipment, Guid spanEquipmentOrSegmentId)
        {
            ...
            List<SpanEquipmentPassageViewLineInfo> lineInfos = new();
                ...
                lineInfos.Add(
                    new SpanEquipmentPassageViewLineInfo(spanEquipmentOrSegmentId)
                    {
                        From = "from blabla",
                        To = "to blabla",
                        ConduitId = "R1234566",
                        OuterConduitInfo = "Ø40 7x12 (Rød tape)",
                        InnerConduitInfo = "Inner conduit 1 (BLUE)"
                    }
                );
            ...
            return (
                new SpanEquipmentPassageViewEquipmentInfo(
                       id: spanEquipment.Id,
