...
namespace OpenFTTH.UtilityGraphService.Business.SpanEquipments.CommandHandlers
{
    public class ConnectSpanSegmentsByIndexCommandHandler : ICommandHandler<ConnectSpanSegmentsByIndexAtRouteNode, Result>
    {
        ...
        public ConnectSpanSegmentsByIndexCommandHandler(IEventStore eventStore, ICommandDispatcher commandDispatcher, IQueryDispatcher queryDispatcher, IExternalEventProducer externalEventProducer)
        {
